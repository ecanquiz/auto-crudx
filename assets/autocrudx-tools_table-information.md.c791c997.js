import{_ as s,o as n,c as a,S as l}from"./chunks/framework.233e4693.js";const i=JSON.parse('{"title":"Información de Tablas","description":"","frontmatter":{},"headers":[],"relativePath":"autocrudx-tools/table-information.md","filePath":"autocrudx-tools/table-information.md"}'),p={name:"autocrudx-tools/table-information.md"},o=l(`<h1 id="informacion-de-tablas" tabindex="-1">Información de Tablas <a class="header-anchor" href="#informacion-de-tablas" aria-label="Permalink to &quot;Información de Tablas&quot;">​</a></h1><p>Al aplicar la configuración del <a href="./../code-debugging.html">depurador de código</a>, <code>autocrudx-tools</code> mostrará en pantalla la información de la tabla a la cual desea generar el CRUD.</p><div class="language-sh"><button title="Copy Code" class="copy"></button><span class="lang">sh</span><pre class="shiki material-theme-palenight"><code><span class="line"><span style="color:#676E95;font-style:italic;"># omitted for brevity ...</span></span>
<span class="line"><span style="color:#A6ACCD;">CRUD_GENERATE</span><span style="color:#89DDFF;">=</span><span style="color:#C3E88D;">FALSE</span></span></code></pre></div><p>Tenga en cuenta lo siguiente:</p><ul><li><code>tableMaster</code>: Nombre de la tabla maestro.</li><li><code>tableStructure</code>: Estructura de la tabla maestro.</li><li><code>tableDetailOfMaster</code>: Tablas detalles del mMaestro (si las hubiera).</li><li><code>tableMasterForeignKeysAssoc</code>: Tablas asociativas del maestro (si las hubiera).</li><li><code>tableStructureClean</code>: Estructura de la tabla maestro sin los campos <code>created_at</code>, <code>updated_at</code> y <code>deleted_at</code>.</li></ul><p>Vamos a los ejemplos...</p><h2 id="ejemplo-basico" tabindex="-1">Ejemplo Básico <a class="header-anchor" href="#ejemplo-basico" aria-label="Permalink to &quot;Ejemplo Básico&quot;">​</a></h2><p>Este ejemplo es para generar un CRUD a una tabla llamada <code>countries</code>. Recuerde antes aplicar la configuración del <a href="./../code-debugging.html">depurador de código</a> para mostrar en pantalla la información de la tabla.</p><div class="language-sh"><button title="Copy Code" class="copy"></button><span class="lang">sh</span><pre class="shiki material-theme-palenight"><code><span class="line"><span style="color:#676E95;font-style:italic;"># omitted for brevity ...</span></span>
...
<span class="line"><span style="color:#89DDFF;">[</span><span style="color:#A6ACCD;">nodemon</span><span style="color:#89DDFF;">]</span><span style="color:#A6ACCD;"> clean exit - waiting for changes before restart</span></span></code></pre></div><p>Tenga en cuenta que para este ejemplo, <code>autocrudx-tools</code> arrojó información de los arreglos <code>tableMaster</code>, <code>tableStructure</code>, <code>tableForeignKeysAssoc</code> y <code>tableStructureClean</code> respectivamente. Mientras que <code>tableDetailOfMaster</code> se trata de un arreglo vacio.</p><h2 id="ejemplo-avanzado" tabindex="-1">Ejemplo Avanzado <a class="header-anchor" href="#ejemplo-avanzado" aria-label="Permalink to &quot;Ejemplo Avanzado&quot;">​</a></h2><p>Este ejemplo es para generar un CRUD a una tabla llamada <code>meetings</code>. Recuerde antes aplicar la configuración del <a href="./../code-debugging.html">depurador de código</a> para mostrar en pantalla la información de la tabla.</p><div class="language-sh"><button title="Copy Code" class="copy"></button><span class="lang">sh</span><pre class="shiki material-theme-palenight"><code><span class="line"><span style="color:#676E95;font-style:italic;"># omitted for brevity ...</span></span>
...
<span class="line"><span style="color:#A6ACCD;">  </span><span style="color:#89DDFF;">]</span></span>
<span class="line"><span style="color:#89DDFF;">}</span></span>
<span class="line"><span style="color:#89DDFF;">[</span><span style="color:#A6ACCD;">nodemon</span><span style="color:#89DDFF;">]</span><span style="color:#A6ACCD;"> clean exit - waiting for changes before restart</span></span></code></pre></div><p>Tenga en cuenta que para este ejemplo, <code>autocrudx-tools</code> arrojó información de los arreglos <code>tableMaster</code>, <code>tableStructure</code>, <code>tableDetailOfMaster</code> <code>tableForeignKeysAssoc</code> y <code>tableStructureClean</code> respectivamente.</p><hr><p>Ahora que el arreglo <code>tableDetailOfMaster</code> tiene información, hagamos un pequeño cambio en el archivo <a href="./../app-ts-file.html"><code>app.ts</code></a>.</p><div class="language-ts"><button title="Copy Code" class="copy"></button><span class="lang">ts</span><pre class="shiki material-theme-palenight has-highlighted-lines"><code><span class="line"><span style="color:#676E95;font-style:italic;">// omitted for brevity ...</span></span>
...
<span class="line"><span style="color:#A6ACCD;">    tableForeignKeysAssoc</span><span style="color:#89DDFF;">:</span><span style="color:#A6ACCD;"> </span><span style="color:#89DDFF;">[]</span></span>
<span class="line"><span style="color:#A6ACCD;">  </span><span style="color:#89DDFF;">}</span></span>
<span class="line"><span style="color:#89DDFF;">]</span></span></code></pre></div><p>Ahora que la tabla detalle <code>attendes</code>, en este caso trae toda información, mostremos un acercamiento.</p><div class="language-ts"><button title="Copy Code" class="copy"></button><span class="lang">ts</span><pre class="shiki material-theme-palenight has-highlighted-lines"><code><span class="line"><span style="color:#676E95;font-style:italic;">// omitted for brevity ...</span></span>
<span class="line"><span style="color:#82AAFF;">main</span><span style="color:#A6ACCD;">(</span></span>
<span class="line"><span style="color:#A6ACCD;">  config</span><span style="color:#89DDFF;">,</span></span>
...
<span class="line"><span style="color:#A6ACCD;">    </span><span style="color:#89DDFF;">}</span></span>
<span class="line"><span style="color:#A6ACCD;">  </span><span style="color:#89DDFF;">]</span></span>
<span class="line"><span style="color:#89DDFF;">}</span></span></code></pre></div><p>En el momento que conocemos cómo trabajar con las <a href="./functional-tools.html">herramientas funcionales</a> y cómo buscar la información de tablas, es tiempo de pasar a desarrollar nuestra <a href="./../stack-folder/intro.html">carpeta stack</a>.</p>`,34),e=[o];function c(t,D,r,y,C,A){return n(),a("div",null,e)}const u=s(p,[["render",c]]);export{i as __pageData,u as default};
