import{_ as s,o as n,c as a,S as l}from"./chunks/framework.233e4693.js";const d=JSON.parse('{"title":"Plantillas","description":"","frontmatter":{},"headers":[],"relativePath":"stack/templates.md","filePath":"stack/templates.md"}'),e={name:"stack/templates.md"},t=l(`<h1 id="plantillas" tabindex="-1">Plantillas <a class="header-anchor" href="#plantillas" aria-label="Permalink to &quot;Plantillas&quot;">​</a></h1><h2 id="stack-my-backend-example" tabindex="-1"><code>stack/my-backend-example</code> <a class="header-anchor" href="#stack-my-backend-example" aria-label="Permalink to &quot;\`stack/my-backend-example\`&quot;">​</a></h2><p><code>./src/stack/my-backend-example/templates/controller</code></p><div class="language-txt"><button title="Copy Code" class="copy"></button><span class="lang">txt</span><pre class="shiki material-theme-palenight"><code><span class="line"><span style="color:#A6ACCD;">&lt;?php</span></span>
...
<span class="line"><span style="color:#A6ACCD;">    }</span></span>
<span class="line"><span style="color:#A6ACCD;">    </span></span>
<span class="line"><span style="color:#A6ACCD;">}</span></span></code></pre></div><p><code>./src/stack/my-backend-example/templates/model</code></p><div class="language-txt"><button title="Copy Code" class="copy"></button><span class="lang">txt</span><pre class="shiki material-theme-palenight"><code><span class="line"><span style="color:#A6ACCD;">&lt;?php</span></span>
<span class="line"><span style="color:#A6ACCD;"></span></span>
...
<span class="line"><span style="color:#A6ACCD;">        }}); %&gt;</span></span>
<span class="line"><span style="color:#A6ACCD;">    ];</span></span>
<span class="line"><span style="color:#A6ACCD;">}</span></span></code></pre></div><p><code>./src/stack/my-backend-example/templates/route</code></p><div class="language-txt"><button title="Copy Code" class="copy"></button><span class="lang">txt</span><pre class="shiki material-theme-palenight"><code><span class="line"><span style="color:#A6ACCD;">&lt;?php</span></span>
<span class="line"><span style="color:#A6ACCD;"></span></span>
<span class="line"><span style="color:#A6ACCD;">use Illuminate\\Http\\Request;</span></span>
...
<span class="line"><span style="color:#A6ACCD;">});</span></span></code></pre></div><h2 id="stack-my-frontend-example" tabindex="-1"><code>stack/my-frontend-example</code> <a class="header-anchor" href="#stack-my-frontend-example" aria-label="Permalink to &quot;\`stack/my-frontend-example\`&quot;">​</a></h2>`,9),p=[t];function o(c,r,i,C,A,u){return n(),a("div",null,p)}const g=s(e,[["render",o]]);export{d as __pageData,g as default};
